...
class STTEngine:
    ...
    async def run(self):
        ...
        while True:
            ...
            utterances, partial = self.segmenter.feed(chunk)

            if partial is not None and self.cfg.echo_transcript:
                text = await loop.run_in_executor(None, self._transcribe, partial)
